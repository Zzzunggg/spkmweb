...
$stmt = $conn->prepare("SELECT * FROM materi_dasar WHERE id = ?");
...
// Ambil materi lain
$materi_lain = $conn->prepare("SELECT * FROM materi_dasar WHERE id != ? ORDER BY id DESC LIMIT 5");
...
<div class="container">
  ...
  <a class="kembali" href="materi_dasar.php">← Kembali ke Materi</a>
    ...
    <div class="materi-lain-list">
      <?php while($m = $materi_lain_result->fetch_assoc()): ?>
        <div class="materi-item">
          ...
          <a href="detail_materi_dasar.php?id=<?= $m['id'] ?>">
