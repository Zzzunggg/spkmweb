...
<head>
    ...
    <style>
        ...
        .btn-download-item {
            ...
            background-color: #343a40; /* Warna hitam/abu tua */
            color: white;
            padding: 8px 15px;
            border-radius: 5px;
        ...
        .btn-download-item:hover {
            background-color: #23272b; /* Warna hitam/abu lebih gelap */
        }
    </style>
</head>
<body>
...
<div class="container">
    ...
    <article class="content" role="main">
        ...
        // Filter diubah menjadi 'hitam'
        $sql_materi = "SELECT * FROM materi_detail WHERE sabuk = 'hitam' ORDER BY urutan ASC";
        // =================================================================
        ...
        <?php
            ...
            // Pesan jika materi untuk sabuk hitam belum ada
            echo "<p style='margin-top: 20px; font-style: italic;'>Materi untuk Sabuk Hitam saat ini belum tersedia.</p>";
        }
        ?>
