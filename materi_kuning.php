...
<head>
    ...
    <title>Materi Sabuk Kuning - Pencak Silat</title>
...
<div class="container">
    ...
    <article class="content" role="main">
        ...
        // Filter diubah dari 'merah' menjadi 'kuning'
        $sql_materi = "SELECT * FROM materi_detail WHERE sabuk = 'kuning' ORDER BY urutan ASC";
        // =================================================================
        ...
        <?php
            ...
            // Pesan jika materi untuk sabuk kuning belum ada
            echo "<p style='margin-top: 20px; font-style: italic;'>Materi untuk Sabuk Kuning saat ini belum tersedia.</p>";
        }
        ?>
