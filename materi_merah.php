...
<head>
    ...
    <style>
        ...
        .btn-download-item {
            ...
            background-color: #c82333; /* Warna merah */
            color: white;
            padding: 8px 15px;
            border-radius: 5px;
        ...
        .btn-download-item:hover {
            background-color: #a21b27; /* Warna merah lebih gelap */
        }
    </style>
</head>
<body>
...
<div class="container">
    ...
    <article class="content" role="main">
        <h1>Daftar Materi Sabuk Merah</h1>
        ...
        // Filter diubah dari 'putih' menjadi 'merah'
        $sql_materi = "SELECT * FROM materi_detail WHERE sabuk = 'merah' ORDER BY urutan ASC";
        // =================================================================
        ...
        <?php
            ...
            // Pesan jika materi untuk sabuk merah belum ada
            echo "<p style='margin-top: 20px; font-style: italic;'>Materi untuk Sabuk Merah saat ini belum tersedia.</p>";
        }
        ?>
